...
import Profile from "../../assets/img/profile/arjun.jpg";
          ...
          <Row className="pt-3 pb-5 align-items-center">
            <Col xs={12} md={6}>
              <Row className="justify-content-center mb-2 mr-2 ">
                <Image className="profile justify-content-end" alt="profile" src={Profile} thumbnail fluid width="350px" height="350px"/>
              </Row>
            </Col>
            <Col xs={12} md={6}>
            ...
            I love learning about new technologies, what problems are they solving and How can I use them to build better and scalable products.
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a href="https://www.linkedin.com/in/nagarjuna-dabbara-mern-and-mean-stack-developer-525451194/" target="_blank" rel="noopener noreferrer">
